...
write.csv(forecast_daily_arima_train, 
         file = "~/Duke_R/TSA_Forecasting/Forecasts/Training/daily_arima.csv",
         row.names = FALSE)
```
...
write.csv(forecast_daily_ets_train, 
         file = "~/Duke_R/TSA_Forecasting/Forecasts/Training/daily_ets.csv",
         row.names = FALSE)
```
...
write.csv(forecast_daily_tbats, 
         file = "~/Duke_R/TSA_Forecasting/Forecasts/Training/daily_tbats.csv",
         row.names = FALSE)
```
...
```{r}
fit_nn_daily_train <- nnetar(load_daily_train_msts,
                      xreg = fourier(load_daily_train_msts, K = c(2, 5)))
...
write.csv(forecast_daily_nn_train, 
          file = "~/Duke_R/TSA_Forecasting/Forecasts/Training/daily_nn.csv",
          row.names = FALSE)
```
...
```{r}
fit_nn_daily <- nnetar(load_daily_msts,
                      xreg = fourier(load_daily_msts, K = c(2, 5)))
...
write.csv(forecast_daily_SSES_train, 
          file = "~/Duke_R/TSA_Forecasting/Forecasts/Training/daily_sses.csv",
          row.names = FALSE)
```
