...
write.csv(forecast_daily_nn, 
          file = "../Forecasts/Raw/forecast_daily_tbats.csv",
          row.names = FALSE)
```
...
knitr::opts_knit$set(root.dir = normalizePath("..")) # or your project root
getwd()
knitr::include_graphics("./Forecasts/NN_daily_113.png")
```
